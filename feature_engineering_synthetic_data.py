...
import numpy as np
import random
from config_features import (INPUT_CSV_TABULAR, OUTPUT_CSV_TABULAR, COLUMNS_TO_DROP_TABULAR, FINAL_COLUMNS_TABULAR)
...
def generate_healthy_dataset(n_rows):
    """
    Genera n_rows pacientes sanos con características epidemiológicamente realistas.
    ...
    for _ in range(n_rows):
        ...
        screening  = gen_screening(age)
        early_det  = gen_early_detection(screening)
        ...
        row = {
            ...
            # Contexto epidemiológico (simulado para sanos)
